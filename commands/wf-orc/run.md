...
- Initialize iteration counters (all start at 0):
  - `code_review_iteration`, `infrastructure_review_iteration`
...
| ui-ux-accessibility-specialist (Phase 2) | T_UI_PASS | code-reviewer | `ui_verification_pass = true` OR `ui_verification_iteration >= 3` |
...
| performance-analyst | T52_6 | devops-infrastructure-engineer | `performance_pass = true` OR `performance_iteration >= 3` |
| devops-infrastructure-engineer | T67 | tech-docs-writer | (`deployment_complete = true` AND `infrastructure_code_needs_review = false`) OR `infrastructure_review_iteration >= 3` |
| devops-infrastructure-engineer | T_DEVOPS_REVIEW | code-reviewer | Infrastructure needs review AND `infrastructure_review_iteration < 3` |
| tech-docs-writer | T70 | project-manager | `documentation_complete = true` OR `documentation_iteration >= 3` |
